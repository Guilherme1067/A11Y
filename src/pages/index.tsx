    ...
    <>
      ...
      <header className={styles.header}>
        ...
        <nav className={styles.nav}>
          <a href="https://github.com/guilherme1067" aria-label="Acessar o github (link externo)">
            <svg aria-hidden="true" stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 512 512" height="28" width="28" xmlns="http://www.w3.org/2000/svg">
